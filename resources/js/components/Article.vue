        ...
        <h2>
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                ...
                placeholder="Title" v-model="article.body"></textarea>
            </div>

            <button type="submit" class="btn btn-light btn-block">Save
            ...
            <div class="card card-body mb-2" v-for="article in articles" v-bind:key="article.id">
                <h3>{{ article.title }}</h3>
                <p style=" font-size:20px; font-weight: lighter;">{{ article.body }}</p>
                <hr>
                 <button @click="editArticle(article)" class="btn btn-warning mb-3"> 
                    Edit
                </button>
